...
VALUES (SEQ_PRODUCTO.NEXTVAL, 'Disco duro SATA3 1TB', 86.99, 5);

INSERT INTO PRODUCTO
VALUES (SEQ_PRODUCTO.NEXTVAL, 'Memoria RAM DDR4 8GB', 120, 6);

INSERT INTO PRODUCTO
VALUES (SEQ_PRODUCTO.NEXTVAL, 'Disco SSD 1 TB', 150.99, 4);

INSERT INTO PRODUCTO
VALUES (SEQ_PRODUCTO.NEXTVAL, 'GeForce GTX 1050Ti', 185, 7);

INSERT INTO PRODUCTO
VALUES (SEQ_PRODUCTO.NEXTVAL, 'GeForce GTX 1080 Xtreme', 755, 6);

INSERT INTO PRODUCTO
VALUES (SEQ_PRODUCTO.NEXTVAL, 'Monitor 24 LED Full HD', 202, 1);

INSERT INTO PRODUCTO
VALUES (SEQ_PRODUCTO.NEXTVAL, 'Monitor 27 LED Full HD', 245.99, 1);

INSERT INTO PRODUCTO
VALUES (SEQ_PRODUCTO.NEXTVAL, 'Portátil Yoga 520', 559, 2);

INSERT INTO PRODUCTO
VALUES (SEQ_PRODUCTO.NEXTVAL, 'Portátil Ideapd 320', 444, 2);

INSERT INTO PRODUCTO
VALUES (SEQ_PRODUCTO.NEXTVAL, 'Impresora HP Deskjet 3720', 59.99, 3);

INSERT INTO PRODUCTO
VALUES (SEQ_PRODUCTO.NEXTVAL, 'Impresora HP Laserjet Pro M26nw', 180, 3);

/*AÑADIR UN ÍNDICE PARA AGILIZAR LAS CONSULTAS SOBRE LA TABLA PRODUCTO CUANDO SE ACCEDA 
 * A LA VEZ CON EL NOMBRE DEL PRODUCTO Y EL CÓDIGO DEL FABRICANTE*/

CREATE INDEX INX_PRODUCTO
ON PRODUCTO(NOMBRE,CODIGO_FABRICANTE)

/*CREA UNA VISTA PARA CONSULAR LOS PRODUCTOS CUYO PRECIO SEA MENOR A 50 Y HACER LA SELECT CORRESPONDIENTE*/
...
INSERT INTO FABRICANTE
VALUES (SEQ_PRODUCTO.NEXTVAL, 'Apple');
